...
# 09/05/2012
# This mod code basically is the same as the original but commented out at certain parts
# to troubleshoot and run in parts
#
#############################################################################
###############################    Header     ###############################
#############################################################################
...
{
    print<<END;
This program (sandbox version) is to predict disease risk for any personal genome sequence
    Available arguments:
    -h mysql host name
    -d database name
    -u user name
